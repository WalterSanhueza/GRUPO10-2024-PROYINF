...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-11-2024 a las 03:24:48
-- Versión del servidor: 10.4.32-MariaDB
-- Versión de PHP: 8.0.30

CREATE DATABASE IF NOT EXISTS `vigifia` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

-- Cambiar al uso de la base de datos
USE `vigifia`;
...
(17, 'Modelos de IA capaces de predecir condiciones futuras de sequía', '2024-10-19 00:03:26', 'Este boletín destaca el avance de científicos que han desarrollado modelos de inteligencia artificial para predecir condiciones futuras de sequía. Estas herramientas permiten mejorar la planificación agrícola y la gestión de recursos hídricos, contribuyen', 'pdf/2.pdf', 'Sequías, Inteligencia artifical agrícola'),
(18, 'Gestión sostenible de recursos hídricos', '2024-10-19 00:03:32', 'Este boletín explora estrategias para gestionar de manera sostenible los recursos hídricos en la agricultura. Se presentan iniciativas que promueven el uso eficiente del agua y la conservación de cuencas, adoptando tecnologías innovadoras para un acceso r', 'pdf/3.pdf', 'Uso eficiente del agua, Conservación hídrica');
...
('00000000-0', 'javier@javier.javier', 'javier', 'diego', 'Equipo TI', 1),
('202023564-3', 'walter.sanhueza@fia.cl', 'Walter Sanhueza', 'contraseña3', 'Bibliotecóloga', 1),
('23456789', 'ana.gomez@example.com', 'Ana Gomez', 'contraseña2', 'Usuario normal', 0),
('321312132-7', 'walter.sanhueza@usm.cl', 'walter', 'fdasfdasfadsf', 'Usuario normal', 0),
('45678901', 'Maca.pozos@fia.cl', 'Macarena del Pozo', 'contraseña4', 'Bibliotecóloga', 1),
('77.777.888-9', 'minis.terio@minAgri.com', 'Ministerio de agricultura', 'contraseña1', 'Cliente', 1);
...
--
ALTER TABLE `boletines`
  MODIFY `idBoletin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
