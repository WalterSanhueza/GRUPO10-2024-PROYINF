...
<div class="navbar">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            ...
            <a href="cerrar.php"><?php echo traducir('cerrar_sesion', $idioma); ?></a>
        </div>
    </div>
    <?php else: ?>
    <div class="auth-links">
        ...
        <a href="#" onclick="cambiarIdioma('en')"><img src="en.png" width="30"></a>
        <a href="#" onclick="cambiarIdioma('fr')"><img src="fr.png" width="30"></a>
        <a href="#" onclick="cambiarIdioma('es')"><img src="es.png" width="30"></a>
        <?php echo "Idioma detectado: " . $idioma;?>
